...
#pragma mark Linear Attributes
     ...
     *
     * @return The distance between this vector and line segment ab
     *
     * {@see distanceSegmentSquared}
     */
    float distanceSegment(const Vec2 a, const Vec2 b) const {
        return sqrt(distanceSegmentSquared(a, b));
    }
    
    /**
     * Returns the squared distance between this vector and line segment ab
     *
     * This method is faster than distanceSegment because it does not need
     * to compute a square root. Hence it is best to us this method when it
     * is not necessary to get the exact distance to the segement (e.g. when
     * simply comparing the distance to a value).
     *
     * @param a The first point of the line segment.
     * @param b The second point of the line segment.
     *
     * @return The squared distance between this vector and line segment ab
     *
     * {@see distanceSegment}
     */
